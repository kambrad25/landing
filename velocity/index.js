...
// manipulate opacity on scroll
    ...
    window.addEventListener("scroll", (e) => {
        ...
        if (window.innerHeight <= 420) {
            ...
            document.querySelector(".scale-wrapper").style.position = "relative";
            ...
            cHeaderOne.style.transition = "none";
            cHeaderTwo.style.transition = "none";
    ...
    window.addEventListener("scroll", (e) => {
        ...
        if (targetTop < height ){
            ...
            // set scale integer to default value
            if (y >= 1) { target.style.transform = "scale(1)";
             } 
             else {
        ...
        //     target.style.transform = "scale(1)";
        //     target.style.transition = "transform 350ms ease";
    ...
    window.addEventListener("resize", (e) => {
        if (window.innerHeight <= 420) {
            let containHeader = document.getElementsByClassName("contain-header"), i;
            i = 0;
            while (i < containHeader.length) {
                containHeader[i].style.left = "4rem";
                containHeader[i].classList.add("ch-show");
                log (containHeader[i]);
                ++i;
            }
        } else {
            containHeader = document.querySelectorAll(".contain-header");
            containHeader.forEach(head => head.classList.remove("ch-show")); 
        }
    })
